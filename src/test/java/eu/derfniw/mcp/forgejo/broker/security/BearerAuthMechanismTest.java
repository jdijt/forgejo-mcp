...
class BearerAuthMechanismTest {
    ...
    private String mintAccessToken(Instant expiresAt) {
        AccessTokenEntry entry = new AccessTokenEntry(
                ...
                new ForgejoTokens(
                        "forgejo-upstream-bearer", "fg-rt", Instant.now().plusSeconds(3600)),
                new ForgejoUser(7L, "tester", "tester@example.com"),
                expiresAt);
    ...
    @Test
    void freshBearerReachesProbeAndCarriesForgejoIdentity() {
        ...
        given().header("Authorization", "Bearer " + token)
                ...
                .body("forgejoBearer", equalTo("forgejo-upstream-bearer"))
